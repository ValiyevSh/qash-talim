    ...
    <div class="my-container">
        <div class="link-in">
            ...
            <div class="main-content ab">
                <button class=" ab2 glavni-btn btn-prev1 btn-prev3">
                ...
                <button class="ab2 glavni-btn btn-next1 btn-next3">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="swiper-fikr swiper my-swwwww">
                    <div class="swiper-wrapper">
                        ...
                        <a href="#" class="card-bg swiper-slide">
                            <img src="img/png/link.png" alt="">
                            <p class="txt-20">
                                www.gov.uz
                            </p>
                            <p class="txt-16">
