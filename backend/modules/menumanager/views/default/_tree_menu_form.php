        ...
        <div class="col-sm-12 col-md-4">
            <?= $form->field($node, 'url_type')->dropDownList([
                ...
                'c-action' => "Sayt bo'limlari",
                    ...
                    else if (t === "category" || t == "c-action" || t=="page" || t=="document" || t=="leader" || t=="link" || t=="news"){
                        $.ajax({
                            url: menu_url,
                            data: {type:t},
                            type: "get",
            ...
            <div class="form-group highlight-addon field-tree-url_value">
                ...
                <div id="menu-value">
                    ...
                    if ($node->url_type == 'category')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(HeaderMenu::find()->all(), 'id', 'name'))->label(false);
                    ...
                    elseif ($node->url_type == 'document')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(DocumentCategory::find()->all(), 'slug', 'title'))->label(false);
                    elseif ($node->url_type == 'leader')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(LeaderCategory::find()->all(), 'slug', 'title'))->label(false);
